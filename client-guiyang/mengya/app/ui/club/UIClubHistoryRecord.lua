local csbPath = app.UIClubHistoryRecordCsb
local super = app.UIBase
local Util = app.Util
local UIManager = app.UIManager
local UITableView = app.UITableView
local UIClubHistoryRecordItem = app.UIClubHistoryRecordItem
local EDITBOX_INPUT_MODE_NUMERIC = 2

local UIClubHistoryRecord = class("UIClubHistoryRecord", super, function() return app.Util:loadCSBNode(csbPath) end)
...
function UIClubHistoryRecord:_onBtnBackClick()
    UIManager:getInstance():hide("UIClubHistoryRecord")
end
