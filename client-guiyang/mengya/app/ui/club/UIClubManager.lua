local csbPath = app.UIClubManagerCsb
local super = app.UIBase
local Util = app.Util
local UIManager = app.UIManager
local UITableView = app.UITableView
local UIClubManagerItem = app.UIClubManagerItem
local UIClubManager = class("UIClubManager", super, function() return app.Util:loadCSBNode(csbPath) end)
