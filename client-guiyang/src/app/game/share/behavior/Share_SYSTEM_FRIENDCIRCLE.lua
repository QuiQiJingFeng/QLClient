...
local shareFunc = require("app.game.share.behavior.base.ShareSDK_System_FriendCircle")
local Version = require "app.kod.util.Version"

local channel = share.constants.CHANNEL.SYSTEM_FRIENDCIRCLE;
local channelidx = share.constants.CHANNELIDX.SYSTEM_FRIENDCIRCLE;
