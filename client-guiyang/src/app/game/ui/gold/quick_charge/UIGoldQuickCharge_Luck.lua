...
local csbPath = 'ui/csb/Gold/QuickCharge/UIGoldQuickCharge_Luck.csb'
local M = class("UIGoldQuickCharge_Luck", super, function() return kod.LoadCSBNode(csbPath) end)
...
function M:ctor(...)
    ...
    self._txtExtraCount = seekNodeByName(self, "BMFont_Extra_Count", "ccui.TextBMFont")
end
...
function M:onShow(argv)
    ...
    self._txtExtraCount:setString(tostring(argv.extraCount))
