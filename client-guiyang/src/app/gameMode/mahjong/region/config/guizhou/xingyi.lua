...
local GamePlay_ZhenFeng = require("app.gameMode.mahjong.region.gamePlays.guizhou.GamePlay_ZhenFeng")
local GamePlay_XingYi = require("app.gameMode.mahjong.region.gamePlays.guizhou.GamePlay_XingYi")
...
local _gameType = {
    ...
    gameTypes = {
        ...
        {
            id = "GAME_TYPE_R_ZHENFENG",
            name = "贞丰麻将",
            destopSkin = "",
			isNew = false,
        },
        {
            id = "GAME_TYPE_R_XINGYI",
            name = "兴仁麻将",
            destopSkin = "",
			isNew = false,
        },
...
如需创建亲友圈及购买亲友圈房卡，请联系“麻友圈”代理。如有疑问，请联系客服微信xymjkf666。]],
    --捉鸡寻宝捕捉器消耗房卡数目
    catcherCost = 1

}

XINGYI.gameType = _gameType
...
XINGYI.registForbidPlay = _registForbidPlay

-- 地区玩法
local _registRuleType = {
    --/** 安龙玩法 */
    GAME_TYPE_R_ANLONG = {RoomSetting.GamePlay.REGION_ANLONG, "", "type", "anlong"},
    --/** 贞丰玩法 */
    GAME_TYPE_R_ZHENFENG = {RoomSetting.GamePlay.REGION_ZHENFENG, "", "type", "anlong"},
    --/** 兴义玩法 */
    GAME_TYPE_R_XINGYI = {RoomSetting.GamePlay.REGION_XINGYI, "", "type", "anlong"},
    ...
    -- 打一张可报听
    GAME_PLAY_TING_CARD = {RoomSetting.GamePlay.GAMEPLAY_TINGCARD, "打一张可报听", "rule", "dapkbt"},
     --/**估卖*/
    ...
    --/**开局翻鸡*/
    GAME_PLAY_CHICKEN_OPENING = {RoomSetting.GamePlay.CHICKEN_OPENING, "开局翻鸡", "rule", "xingqj"},
    -- 顺5清10(一扣二)
    GAME_PLAY_COUNTPOINTS_SHUNWUQINGSHI = {RoomSetting.GamePlay.COUNTPOINTS_SHUNWUQINGSHI, "顺5清10", "rule", "yike"},
    -- 顺3清6(通三)
    GAME_PLAY_COUNTPOINTS_SHUNSANQINGLIU = {RoomSetting.GamePlay.COUNTPOINTS_SHUNSANQINGLIU, "顺3清6", "rule", "lianzh"},
...
XINGYI.registRuleType = _registRuleType

local gameplays = {
	["GAME_TYPE_R_XINGYI"] = GamePlay_XingYi,
	["GAME_TYPE_R_ZHENFENG"] = GamePlay_ZhenFeng,
	["GAME_TYPE_R_ANLONG"] = GamePlay_AnLong,
}
-- setfenv(utils.addGamePlays, {_G = GUIYANG, _g = _G})
utils.addGamePlays(XINGYI, gameplays)
