...
local _roomSetting = room.GameTypeSetting.new("GAME_TYPE_R_TONGREN",
{
	--/**局数圈数*/
	...
	room.RuleSetting.new("",
	{
		room.RuleOption.new("GAME_PLAY_SHAO_JI_SHAO_DOU", "", ""),
	}, false),
	
	--/**包鸡*/
	room.RuleSetting.new("",
	{
		room.RuleOption.new("GAME_PLAY_BAO_JI", "", ""),
	}, false),
	
	--/**包豆*/
	room.RuleSetting.new("",
	{
		room.RuleOption.new("GAME_PLAY_BAO_DOU", "", ""),
	}, false),
	--/**两房*/
	room.RuleSetting.new("",
	{
		room.RuleOption.new("GAME_PLAY_CHICKEN_LIANGFANG", "", ""),
	}, false),
	--/**本鸡*/
	room.RuleSetting.new("",
	{
	...
	room.RuleSetting.new("GAME_PLAY_BANKER_ONE",
	{
		...
		room.RuleOption.new("GAME_PLAY_YIKOUSAN", "", ""),
	}, true),
	...
	room.RuleSetting.new("",
	{
		room.RuleOption.new("GAME_PLAY_CHICKEN_DILONG", "", ""),
	}, false),
...
TongRen.roomSetting = _roomSetting
...
local _commonEvent = {
	...
	[PlayType.HU_RUAN_BAO]						= {name = "报听"		, be = "报听"		, skin = "mahjong_tile/img_55", beskin = "mahjong_tile/img_55", weight = - 1},
	...
	[PlayType.HU_TIAN_HU]						= {name = "天胡"		, be = "天胡"		, skin = "mahjong_tile/img_55", beskin = "mahjong_tile/img_55", weight = - 1},
	...
	[PlayType.DISPLAY_JI_NORMAL]					= {name = "幺鸡"	, be = "幺鸡"	, skin = "mahjong_tile/icon_41", beskin = "mahjong_tile/icon_41", weight = - 1},
	...
	[PlayType.DISPLAY_JI_NORMAL_FANPEI]			= {name = "幺鸡(包)", be = "幺鸡(包)", skin = "mahjong_tile/icon_156", beskin = "mahjong_tile/icon_156", weight = - 1},
	[PlayType.DISPLAY_JI_WUGU_FANPEI]				= {name = "乌骨鸡(包)", be = "乌骨鸡(包)", skin = "mahjong_tile/icon_156", beskin = "mahjong_tile/icon_156", weight = - 1},
	[PlayType.DISPLAY_JI_NORMAL_GOLD_FANPEI]		= {name = "金鸡(包)"	, be = "金鸡(包)"	, skin = "mahjong_tile/icon_156", beskin = "mahjong_tile/icon_156", weight = - 1},
	[PlayType.DISPLAY_JI_WUGU_GOLD_FANPEI]		= {name = "金乌骨(包)", be = "金乌骨(包)", skin = "mahjong_tile/icon_156", beskin = "mahjong_tile/icon_156", weight = - 1},
	...
	[PlayType.DISPLAY_JI_SHOUQUAN_FANPEI]			= {name = "首圈鸡(包)", be = "首圈鸡(包)", skin = "mahjong_tile/icon_156", beskin = "mahjong_tile/icon_156", weight = - 1},
	[PlayType.DISPLAY_JI_SHOUQUAN_GOLD]			= {name = "首圈金鸡"	, be = "首圈金鸡"	, skin = "mahjong_tile/icon_156", beskin = "mahjong_tile/icon_156", weight = - 1},
	[PlayType.DISPLAY_JI_SHOUQUAN_GOLD_FANPEI]	= {name = "首圈金鸡(包)", be = "首圈金鸡(包)", skin = "mahjong_tile/icon_156", beskin = "mahjong_tile/icon_156", weight = - 1},
	...
	[PlayType.HU_QING_DAN_DIAO]					= {name = "清单吊"	, be = "清单吊"	, skin = "mahjong_tile/"		, beskin = ""					, weight = - 1},
	...
	[PlayType.DISPLAY_PEI_GANG] = {name = "赔杠", be = "赔杠", skin = "mahjong_tile/icon_zhuang2", beskin = "mahjong_tile/icon_zhuang2", weight = - 1},
	
	[PlayType.OPERATE_GANG_A_CARD_PEI]	= {name = "明豆(包)", be = "明豆(包)", skin = "mahjong_tile/img_62", beskin = "mahjong_tile/img_61", weight = - 1},
	[PlayType.OPERATE_AN_GANG_PEI]		= {name = "闷豆(包)", be = "闷豆(包)", skin = "mahjong_tile/img_59", beskin = "mahjong_tile/img_59", weight = - 1},
	[PlayType.OPERATE_BU_GANG_A_CARD_PEI] = {name = "转弯豆(包)", be = "转弯豆(包)", skin = "mahjong_tile/img_60", beskin = "mahjong_tile/img_60", weight = - 1},
}

TongRen.commonEvent = _commonEvent
...
TongRen.commands = _commands
TongRen.replayCommands = _replayCommands

local _uiConifg = {
	UILack = "app.gameMode.mahjong.region.commands.lack.UILack",
	UI_GAME_TYPE_R_TONGREN = "app.gameMode.mahjong.region.gamePlays.guizhou.UI_GAME_TYPE_R_TONGREN"
}

TongRen.UIConfig = _uiConifg
