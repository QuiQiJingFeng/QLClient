...
local AnShun_GuiYang = {}

local _roomSetting = room.GameTypeSetting.new("GAME_TYPE_R_ANSHUN_GUIYANG",
{
    --/**局数圈数*/
...
AnShun_GuiYang.roomSetting = _roomSetting
...
AnShun_GuiYang.commonEvent = _commonEvent
...
AnShun_GuiYang.commands = _commands
AnShun_GuiYang.replayCommands = _replayCommands

local _uiConifg = {
    UILack = "app.gameMode.mahjong.region.commands.lack.UILack",
    UI_GAME_TYPE_R_ANSHUN_GUIYANG = "app.gameMode.mahjong.region.gamePlays.guizhou.UI_GAME_TYPE_R_ANSHUN_GUIYANG"
}

AnShun_GuiYang.UIConfig = _uiConifg

return AnShun_GuiYang