...
local _roomSetting = room.GameTypeSetting.new("GAME_TYPE_R_LIANG_FANG",
{
	 --/**局数*/
    ...
    room.RuleSetting.new("GAME_PLAY_BANKER_ONE",
    {
        ...
        room.RuleOption.new("GAME_PLAY_BANKER_TONGSAN", "", ""),
    }, true),
    --/**实时语音 */
...
LiangFang.roomSetting = _roomSetting
...
LiangFang.commonEvent = _commonEvent
...
LiangFang.commands = _commands
LiangFang.replayCommands = _replayCommands

local _uiConifg = {
	UILack = "app.gameMode.mahjong.region.commands.lack.UILack",
	UI_GAME_TYPE_R_LIANG_FANG = "app.gameMode.mahjong.region.gamePlays.guizhou.UI_GAME_TYPE_R_LIANG_FANG"
}

LiangFang.UIConfig = _uiConifg
