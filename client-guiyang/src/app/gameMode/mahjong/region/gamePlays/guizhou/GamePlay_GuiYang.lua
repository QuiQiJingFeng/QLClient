...
local _roomSetting = room.GameTypeSetting.new("GAME_TYPE_R_GUIYANG",
{
    --/**局数圈数*/
    ...
    room.RuleSetting.new("",
    {
        room.RuleOption.new("GAME_PLAY_HOT_PAO_MUST_HU", "", ""),
    }, false),
...
GuiYang.roomSetting = _roomSetting
...
GuiYang.commonEvent = _commonEvent
...
local _commands = {
    ...
    -- 癞子鸡
    -- [PlayType.DISPLAY_DEAL_MASTER_CARD] = require("app.gameMode.mahjong.region.commands.guipai.Command_LaiZiJi"),
...
GuiYang.commands = _commands
GuiYang.replayCommands = _replayCommands

local _uiConifg = {
    UILack = "app.gameMode.mahjong.region.commands.lack.UILack",
    UI_GAME_TYPE_R_GUIYANG = "app.gameMode.mahjong.region.gamePlays.guizhou.UI_GAME_TYPE_R_GUIYANG",
    UIHuanSanZhang = "app.gameMode.mahjong.region.commands.huansanzhang.UIHuanSanZhang"
}

GuiYang.UIConfig = _uiConifg
