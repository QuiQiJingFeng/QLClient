...
local _roomSetting = room.GameTypeSetting.new("GAME_TYPE_R_ANSHUN",
{
    --/**局数圈数*/
    ...
    --/**鸡牌翻法 */
    room.RuleSetting.new("GAME_PLAY_CHICKEN_SWING",
    {
        room.RuleOption.new("GAME_PLAY_CHICKEN_FLOP", "", ""),
        room.RuleOption.new("GAME_PLAY_CHICKEN_SWING", "", ""),
    }, true),
    --/**本鸡*/
    room.RuleSetting.new("GAME_PLAY_CHICKEN_BENJI",
    {
        room.RuleOption.new("GAME_PLAY_CHICKEN_BENJI", "", ""),
    }, false),
    --/**乌骨鸡*/
    room.RuleSetting.new("GAME_PLAY_CHICKEN_WUGU",
    {
    ...
    --/**满堂鸡*/
    room.RuleSetting.new("GAME_PLAY_CHICKEN_MANTANGJI",
    {
        room.RuleOption.new("GAME_PLAY_CHICKEN_MANTANGJI", "", ""),
    }, false),

    --/**抢杠烧鸡*/
    room.RuleSetting.new("GAME_PLAY_QGSJ",
    {
        room.RuleOption.new("GAME_PLAY_QGSJ", "", ""),
    }, false),

    --/**定缺*/
    room.RuleSetting.new("",
    {
        room.RuleOption.new("GAME_PLAY_LACK", "", ""),
    }, false),
    ...
    --/**抢杠烧豆*/
    room.RuleSetting.new("GAME_PLAY_QGSD",
    {
        room.RuleOption.new("GAME_PLAY_QGSD", "", ""),
    }, false),
...
AnShun.roomSetting = _roomSetting
...
local _commonEvent = {
    ...
    [PlayType.HU_BIAN_KA_DIAO] = {name = "边卡吊", be = "", skin = "mahjong_tile/icon_90", beskin = "mahjong_tile/icon_90", weight = - 1},
    [PlayType.HU_DAKUANZHANG] = {name = "大宽张", be = "", skin = "mahjong_tile/icon_161", beskin = "mahjong_tile/icon_161", weight = - 1},
    ...
    [PlayType.HU_QING_DAN_DIAO] = {name = "清单吊", be = "", skin = "mahjong_tile/"		, beskin = ""					, weight = - 1},
    ...
    [PlayType.HU_RUAN_BAO]			= {name = "天听", be = "天听", skin = "mahjong_tile/icon_159", beskin = "mahjong_tile/icon_159", weight = - 1},
    ...
    [PlayType.DISPLAY_JI_WUGU_ZEREN_GOLD]			= {name = "责任金乌骨", be = "责任金乌骨", skin = "mahjong_tile/icon_95", beskin = "mahjong_tile/icon_95", weight = - 1},
...
AnShun.commonEvent = _commonEvent
...
AnShun.commands = _commands
AnShun.replayCommands = _replayCommands

local _uiConifg = {
    UILack = "app.gameMode.mahjong.region.commands.lack.UILack",
    UI_GAME_TYPE_R_ANSHUN = "app.gameMode.mahjong.region.gamePlays.guizhou.UI_GAME_TYPE_R_ANSHUN"
}

AnShun.UIConfig = _uiConifg
