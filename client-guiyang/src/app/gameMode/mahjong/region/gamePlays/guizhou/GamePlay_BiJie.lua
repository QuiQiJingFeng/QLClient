...
local _roomSetting = room.GameTypeSetting.new("GAME_TYPE_R_BIJIE",
{
    --/**局数圈数*/
    ...
    room.RuleSetting.new("",
    {
        room.RuleOption.new("GAME_PLAY_CHICKEN_HONGZHONG", "", ""),
    }, false),
    -- 连庄
    room.RuleSetting.new("",
    {
...
BiJie.roomSetting = _roomSetting
...
local _commonEvent = {
    ...
    [PlayType.DISPLAY_JI_CHONGFENG_FANPEI]           = {name = "冲锋鸡(赔)"  , be = "冲锋鸡(赔)"      , skin = "mahjong_tile/icon_156", beskin = "mahjong_tile/icon_156", weight = -1},
    ...
    [PlayType.DISPLAY_JI_HONGZHONG]                  = {name = "红中鸡", be = "红中鸡", skin = "mahjong_tile/icon_156", beskin = "mahjong_tile/icon_156", weight = -1},
    [PlayType.DISPLAY_JI_JIPIN]                      = {name = "极品鸡", be = "极品鸡", skin = "mahjong_tile/icon_156", beskin = "mahjong_tile/icon_156", weight = -1},
    ...
    [PlayType.OPERATE_BU_GANG_A_CARD] = {name = "爬坡豆", be = "爬坡豆", skin = "mahjong_tile/img_60", beskin = "mahjong_tile/img_60", weight = -1},

    [PlayType.DISPLAY_LIANZHUANG] = {name = "连庄", be = "连庄", skin = "mahjong_tile/icon_zhuang2", beskin = "mahjong_tile/icon_zhuang2", weight = -1},
}

BiJie.commonEvent = _commonEvent
...
local _commands = {
	...
	[PlayType.DISPLAY_HONG_ZHONG] = require("app.gameMode.mahjong.region.commands.hongzhong.Command_HongZhong"),
}
...
BiJie.commands = _commands
BiJie.replayCommands = _replayCommands

local _uiConifg = {
    UILack = "app.gameMode.mahjong.region.commands.lack.UILack",
    UI_GAME_TYPE_R_BIJIE = "app.gameMode.mahjong.region.gamePlays.guizhou.UI_GAME_TYPE_R_BIJIE"
}

BiJie.UIConfig = _uiConifg
