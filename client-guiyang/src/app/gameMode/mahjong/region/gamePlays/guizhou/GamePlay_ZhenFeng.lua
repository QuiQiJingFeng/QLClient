...
local _roomSetting = room.GameTypeSetting.new("GAME_TYPE_R_ZHENFENG",
{
    --/**局数圈数*/
    ...
    room.RuleSetting.new("",
    {
        room.RuleOption.new("GAME_PLAY_CHICKEN_OPENING", "", ""),
    }, false),
    --/** 两房*/
    room.RuleSetting.new("",
    {
    ...
    --/**算分翻法 */
    room.RuleSetting.new("GAME_PLAY_COUNTPOINTS_SHUNWUQINGSHI",
    {
        room.RuleOption.new("GAME_PLAY_COUNTPOINTS_SHUNWUQINGSHI", "", ""),
        room.RuleOption.new("GAME_PLAY_COUNTPOINTS_SHUNSANQINGLIU", "", ""),
    }, true),
    --/**实时语音 */
...
ZhenFeng.roomSetting = _roomSetting
...
ZhenFeng.commonEvent = _commonEvent
...
local _commands = {
	...
	[PlayType.DISPLAY_JI_KAIJUFANJI] = require("app.gameMode.mahjong.region.commands.ji.Command_KaiJuFanJi"),
}
...
ZhenFeng.commands = _commands
ZhenFeng.replayCommands = _replayCommands

local _uiConifg = {
    UILack = "app.gameMode.mahjong.region.commands.lack.UILack",
    UI_GAME_TYPE_R_ZHENFENG = "app.gameMode.mahjong.region.gamePlays.guizhou.UI_GAME_TYPE_R_ZHENFENG"
}

ZhenFeng.UIConfig = _uiConifg
