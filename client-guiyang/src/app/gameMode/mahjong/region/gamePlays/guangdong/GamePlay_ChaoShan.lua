...
local _roomSetting = room.GameTypeSetting.new("GAME_TYPE_CHAO_SHAN",
{
	...
	--[[      
         * 倍数
         * 1、选了吃胡，才能选小胡和鸡胡不能吃胡。
         * 2、小胡不选，视为大胡。大胡下，才可以选“鸡胡不能吃胡”
    ]]
	room.RuleSetting.new("",
	{
		room.RuleOption.new("SCORE_XIAO_HU", "Hu_DIAN_HU", ""),
	}, false),
	room.RuleSetting.new("",
	{
		-- 鸡胡不能吃胡
		room.RuleOption.new("SCORE_XIAO_HU_WITHOUT_DIAN_HU", "(not SCORE_XIAO_HU and not Hu_ZI_MO)", ""),
	}, false),
	room.RuleSetting.new("",
	{
	...
	room.RuleSetting.new("GAME_PLAY_FOUR_PLAYER",
	{
		...
		room.RuleOption.new("GAME_PLAY_FOUR_PLAYER", "", ""),
	     room.RuleOption.new("GAME_PLAY_TWO_PLAYER", "", ""),
	}, true),
	...
	-- 吃杠杠爆全包
	room.RuleSetting.new("CHI_GANG_GANG_BAO_QUAN_BAO",
	{
		room.RuleOption.new("CHI_GANG_GANG_BAO_QUAN_BAO", "", ""),
	}, false),
	
	-- 流局算杠
	room.RuleSetting.new("LIU_JU_SUAN_GANG",
	{
		room.RuleOption.new("LIU_JU_SUAN_GANG", "", ""),
	}, false),
	
	--/**必胡*/
	room.RuleSetting.new("SCORE_MUST_HU",
	{
		room.RuleOption.new("SCORE_MUST_HU", "", ""),
	}, false),

	--/**最后一圈不能碰*/
	room.RuleSetting.new("CANNT_PENG_IN_LAST_CIRCLE",
	{
		room.RuleOption.new("CANNT_PENG_IN_LAST_CIRCLE", "", ""),
	}, false),
...
ChaoShan.roomSetting = _roomSetting
...
ChaoShan.commonEvent = _commonEvent
...
ChaoShan.commands = _commands
ChaoShan.replayCommands = _replayCommands

local _uiConifg = {
	UILack = "app.gameMode.mahjong.region.commands.lack.UILack",
	UI_GAME_TYPE_CHAO_SHAN = "app.gameMode.mahjong.region.gamePlays.guangdong.UI_GAME_TYPE_CHAO_SHAN"
}

ChaoShan.UIConfig = _uiConifg
