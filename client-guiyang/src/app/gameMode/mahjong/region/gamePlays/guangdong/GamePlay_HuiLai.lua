...
local _roomSetting = room.GameTypeSetting.new("GAME_TYPE_HUI_LAI", {
	...
	{
		-- 杠跟底分
		room.RuleOption.new("GANG_GEN_DI_FEN", "", ""),
	}, false),
	room.RuleSetting.new("",
	{
		-- 流局算杠
...
HuiLai.roomSetting = _roomSetting
...
HuiLai.commonEvent = _commonEvent
...
HuiLai.commands = _commands
HuiLai.replayCommands = _replayCommands

local _uiConifg = {
	UILack = "app.gameMode.mahjong.region.commands.lack.UILack",
	UI_GAME_TYPE_HUI_LAI = "app.gameMode.mahjong.region.gamePlays.guangdong.UI_GAME_TYPE_HUI_LAI"
}

HuiLai.UIConfig = _uiConifg
