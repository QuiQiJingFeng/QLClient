...
local _roomSetting = room.GameTypeSetting.new("GAME_TYPE_GUI_CHAO_SHAN",
{
...
GuiChaoShan.roomSetting = _roomSetting
...
GuiChaoShan.commonEvent = _commonEvent
...
GuiChaoShan.commands = _commands
GuiChaoShan.replayCommands = _replayCommands

local _uiConifg = {
	UILack = "app.gameMode.mahjong.region.commands.lack.UILack",
	UI_GAME_TYPE_GUI_CHAO_SHAN = "app.gameMode.mahjong.region.gamePlays.guangdong.UI_GAME_TYPE_GUI_CHAO_SHAN"
}

GuiChaoShan.UIConfig = _uiConifg
