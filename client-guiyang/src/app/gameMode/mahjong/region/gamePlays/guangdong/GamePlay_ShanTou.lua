...
local _roomSetting = room.GameTypeSetting.new("GAME_TYPE_SHAN_TOU",
{
	...
	room.RuleSetting.new("GAME_PLAY_FOUR_PLAYER",
	{
		room.RuleOption.new("GAME_PLAY_THREE_PLAYER", "", ""),
		room.RuleOption.new("GAME_PLAY_FOUR_PLAYER", "", ""),
	}, true),
	
	--玩法 ，可不选，默认不选 -- 无字和无风只能二选一，或者不选
	room.RuleSetting.new("",
	{
		room.RuleOption.new("GAME_PLAY_NO_WAN", "", ""),
		room.RuleOption.new("GAME_PLAY_NO_ZI", "", ""),
	}, false),
	...
	room.RuleSetting.new("Hu_DIAN_HU",
	{
		...
		room.RuleOption.new("HU_ZI_MO_SHAN_TOU", "", ""),
	}, true),
	
	--[[ 鸡胡不可吃胡]]
	room.RuleSetting.new("",
	{
		room.RuleOption.new("SCORE_XIAO_HU_WITHOUT_DIAN_HU", "Hu_DIAN_HU", "Hu_DIAN_HU")
	}, false),
	-- 10倍不计分
	room.RuleSetting.new("",
	{
		room.RuleOption.new("HU_ZI_MO_TARGET_SCORE_LIMIT", "HU_ZI_MO_SHAN_TOU", "HU_ZI_MO_SHAN_TOU"),
	}, false),
	--20分可吃胡
	room.RuleSetting.new("",
	{
		room.RuleOption.new("HU_CHI_HU_ZI_MO_LIMIT", "HU_ZI_MO_SHAN_TOU", "HU_ZI_MO_SHAN_TOU"),
	}, false),
	--抢杠胡3倍
	room.RuleSetting.new("QIANG_GANG_HU_THREE",
	{
		room.RuleOption.new("QIANG_GANG_HU_THREE", "", ""),
	}, false),
	--海底捞月2倍
	room.RuleSetting.new("HAI_DI_LAO_YUE_DOUBLE",
	{
		room.RuleOption.new("HAI_DI_LAO_YUE_DOUBLE", "", ""),
	}, false),
	--杠爆2倍
	room.RuleSetting.new("GANG_BAO_DOUBLE",
	{
		room.RuleOption.new("GANG_BAO_DOUBLE", "", ""),
	}, false),
	--吃杠杠爆全包
	room.RuleSetting.new("",
	{
		room.RuleOption.new("CHI_GANG_GANG_BAO_QUAN_BAO", "GANG_BAO_DOUBLE", ""),
	}, false),
	
	
	--[[      倍数 全牌型、大、小胡
    ]]
	room.RuleSetting.new("SHAN_TOU_DA_HU",
	{
		room.RuleOption.new("SHAN_TOU_QUAN_PAI_XING", "", ""),
		room.RuleOption.new("SHAN_TOU_XIAO_HU", "", ""),
		room.RuleOption.new("SHAN_TOU_DA_HU", "", ""),
	}, true),
	-- 汕头碰碰胡4分
	room.RuleSetting.new("SHAN_TOU_PENG_PENG_HU",
	{
		room.RuleOption.new("SHAN_TOU_PENG_PENG_HU", "SHAN_TOU_DA_HU", ""),
	}, false),
	-- 汕头混一色4分
	room.RuleSetting.new("SHAN_TOU_HUN_YI_SE",
	{
		room.RuleOption.new("SHAN_TOU_HUN_YI_SE", "SHAN_TOU_DA_HU", ""),
	}, false),
	-- 汕头清一色4分
	room.RuleSetting.new("SHAN_TOU_QING_YI_SE",
	{
		room.RuleOption.new("SHAN_TOU_QING_YI_SE", "SHAN_TOU_DA_HU", ""),
	}, false),
	-- 汕头一条龙6分
	room.RuleSetting.new("SHAN_TOU_YI_TIAO_LONG",
	{
		room.RuleOption.new("SHAN_TOU_YI_TIAO_LONG", "SHAN_TOU_DA_HU", ""),
	}, false),
	-- 汕头一九10分
	room.RuleSetting.new("SHAN_TOU_YAO_JIU",
	{
		room.RuleOption.new("SHAN_TOU_YAO_JIU", "SHAN_TOU_DA_HU", ""),
	}, false),
	-- 汕头小三元10分
	room.RuleSetting.new("SHAN_TOU_XIAO_SAN_YUAN",
	{
		room.RuleOption.new("SHAN_TOU_XIAO_SAN_YUAN", "SHAN_TOU_DA_HU and not GAME_PLAY_NO_ZI", ""),
	}, false),
	-- 汕头小四喜10分
	room.RuleSetting.new("SHAN_TOU_XIAO_SI_XI",
	{
		room.RuleOption.new("SHAN_TOU_XIAO_SI_XI", "SHAN_TOU_DA_HU and not GAME_PLAY_NO_ZI", ""),
	}, false),
	-- 汕头字一色20分
	room.RuleSetting.new("SHAN_TOU_ZI_YI_SE",
	{
		room.RuleOption.new("SHAN_TOU_ZI_YI_SE", "SHAN_TOU_XIAO_HU or SHAN_TOU_DA_HU", ""),
	}, false),
	-- 汕头十三幺26分
	room.RuleSetting.new("SHAN_TOU_SHI_SAN_YAO",
	{
		room.RuleOption.new("SHAN_TOU_SHI_SAN_YAO", "(SHAN_TOU_XIAO_HU or SHAN_TOU_DA_HU) and not GAME_PLAY_NO_ZI and not GAME_PLAY_NO_WAN", ""),
	}, false),
	-- 汕头大三元20分
	room.RuleSetting.new("SHAN_TOU_DA_SAN_YUAN",
	{
		room.RuleOption.new("SHAN_TOU_DA_SAN_YUAN", "(SHAN_TOU_XIAO_HU or SHAN_TOU_DA_HU) and not GAME_PLAY_NO_ZI", ""),
	}, false),
	-- 汕头大四喜20分
	room.RuleSetting.new("SHAN_TOU_DA_SI_XI",
	{
		room.RuleOption.new("SHAN_TOU_DA_SI_XI", "(SHAN_TOU_XIAO_HU or SHAN_TOU_DA_HU) and not GAME_PLAY_NO_ZI", ""),
	}, false),
	-- 汕头十八罗汉36分
	room.RuleSetting.new("SHAN_TOU_SHI_BA_LUO_HAN",
	{
		room.RuleOption.new("SHAN_TOU_SHI_BA_LUO_HAN", "SHAN_TOU_XIAO_HU or SHAN_TOU_DA_HU", ""),
	}, false),
	-- 汕头七小对6、豪气10、双豪20、三豪30分
	room.RuleSetting.new("SHAN_TOU_QI_DUI_ALL",
	{
		room.RuleOption.new("SHAN_TOU_QI_DUI_ALL", "SHAN_TOU_XIAO_HU or SHAN_TOU_DA_HU", ""),
	}, false),
	-- 天胡40分，地胡20分
	room.RuleSetting.new("SHAN_TOU_TIAN_DI",
	{
		room.RuleOption.new("SHAN_TOU_TIAN_DI", "SHAN_TOU_XIAO_HU or SHAN_TOU_DA_HU", ""),
	}, false),
	
	-- 跟庄
	room.RuleSetting.new("SCORE_GEN_ZHUANG",
	{
		room.RuleOption.new("SCORE_GEN_ZHUANG", "(not GAME_PLAY_THREE_PLAYER and not GAME_PLAY_TWO_PLAYER)", ""),
	}, false),
	
	-- 流局算杠
	room.RuleSetting.new("",
	{
		room.RuleOption.new("LIU_JU_SUAN_GANG", "", ""),
	}, false),
	
	-- 封顶
	room.RuleSetting.new("SCORE_LIMIT_5",
	{
...
ShanTou.roomSetting = _roomSetting
...
ShanTou.commonEvent = _commonEvent
...
ShanTou.commands = _commands
ShanTou.replayCommands = _replayCommands

local _uiConifg = {
	UILack = "app.gameMode.mahjong.region.commands.lack.UILack",
	UI_GAME_TYPE_SHAN_TOU = "app.gameMode.mahjong.region.gamePlays.guangdong.UI_GAME_TYPE_SHAN_TOU"
}

ShanTou.UIConfig = _uiConifg
