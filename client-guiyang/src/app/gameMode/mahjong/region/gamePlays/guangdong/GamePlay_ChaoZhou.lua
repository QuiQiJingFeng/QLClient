...
local _roomSetting = room.GameTypeSetting.new("GAME_TYPE_CHAO_ZHOU",
{
	...
	room.RuleSetting.new("SCORE_GEN_ZHUANG_YI_FEN",
	{
		room.RuleOption.new("SCORE_GEN_ZHUANG_YI_FEN", "(not GAME_PLAY_THREE_PLAYER and not GAME_PLAY_TWO_PLAYER)", ""),
	}, false),
	...
	-- 十倍不计分
	room.RuleSetting.new("SHI_BEI_BU_JI_FEN",
	{
		room.RuleOption.new("SHI_BEI_BU_JI_FEN", "", ""),
	}, false),
...
ChaoZhou.roomSetting = _roomSetting
...
ChaoZhou.commonEvent = _commonEvent
...
ChaoZhou.commands = _commands
ChaoZhou.replayCommands = _replayCommands

local _uiConifg = {
	UILack = "app.gameMode.mahjong.region.commands.lack.UILack",
	UI_GAME_TYPE_CHAO_ZHOU = "app.gameMode.mahjong.region.gamePlays.guangdong.UI_GAME_TYPE_CHAO_ZHOU"
}

ChaoZhou.UIConfig = _uiConifg
