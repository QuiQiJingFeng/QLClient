local super = require "app.gameMode.zhengshangyou.processor.PlayerProcessor_Other"
local CardList_ZhengShangYou = require "app.gameMode.zhengshangyou.ui.CardList_ZhengShangYou"
local UITableOptions_ZhengShangYou = require "app.gameMode.zhengshangyou.ui.UITableOptions_ZhengShangYou"
...
function PlayerProcessor_Local:ctor(cPos, playerInfo, uiPlayer)
    ...
    self._cardList = CardList_ZhengShangYou.new(container)
    self._uiTableOptions = UITableOptions_ZhengShangYou.new(nodeTableOptions, self._cardList, self)
