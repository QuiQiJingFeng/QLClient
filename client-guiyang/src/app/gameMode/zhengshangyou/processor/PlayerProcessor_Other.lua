...
local commonSoundMap = {
    ...
    [Constants.PlayType.POKER_DISPLAY_PAI_SAN_SHUNZI] = "seriesThree.mp3",
    -- 飞机
    ...
    --四带一
    [Constants.PlayType.POKER_DISPLAY_PAI_SI_DAI_1_ZHANG] = "bomb.mp3",
    --三顺子
}
...
function PlayerProcessor_Other:getChairType()
