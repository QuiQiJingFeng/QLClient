...
local Constants = class("Constants_ZhengShangYou", base)
...
Constants.PlayType = {
    ...
    -- 四带一
    POKER_DISPLAY_PAI_SI_DAI_1_ZHANG = 1049901,
    --三顺 如333444,555666
    POKER_DISPLAY_PAI_SAN_SHUNZI = 1049903,
    ...
    -- 春天
    POKER_DISPLAY_SPRING = 1049902,
    --底分
    POKER_DISPLAY_BOTTOM_SCORE = 1049939,
}
