...
local UITableOptions_Paodekuai = class("UITableOptions_Paodekuai", super)
UITableOptions_Paodekuai.sort = {
    pass = 1, -- 小值在左
    tips = 2,
    discard = 3,
}
function UITableOptions_Paodekuai:ctor(root, cardList, processor)
    self._root = root
...
function UITableOptions_Paodekuai:_init()
    self._btns = {
...
function UITableOptions_Paodekuai:_registeCallback()
...
function UITableOptions_Paodekuai:addValue(str)
...
function UITableOptions_Paodekuai:setEnable(value)
    self._root:setVisible(value or false)
end

function UITableOptions_Paodekuai:cleanUp()
    self._usedBtnKeyArray = {}
    self:_refresh()
end
...
function UITableOptions_Paodekuai:_refresh()
    ...
    table.sort(self._usedBtnKeyArray, function(key1, key2)
        local v1 = UITableOptions_Paodekuai.sort[key1] or -1
        local v2 = UITableOptions_Paodekuai.sort[key2] or -1
        return v1 < v2
    end)
...
function UITableOptions_Paodekuai:_onBtnPassClicked(sender)
...
function UITableOptions_Paodekuai:_onBtnTipsClicked(sender)
...
function UITableOptions_Paodekuai:setTipsHandler(callback)
    self._tipsCallbak = callback
end

function UITableOptions_Paodekuai:_onBtnDiscardClicked(sender)
...
function UITableOptions_Paodekuai:_sendPlayType(playType, cards, datas)
    cards = cards or {}
    datas = datas or {}
...
function UITableOptions_Paodekuai:prepareForNextRound()
    self:cleanUp()
end

function UITableOptions_Paodekuai:dispose()
    self._tipsCallbak = nil
    self._passCallback = nil
end

return UITableOptions_Paodekuai