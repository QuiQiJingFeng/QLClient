...
--------------------每一个tips的单个实例--------------------
local UIMessageTips = class("UIMessageTips", function () return Util:loadCSBNode(csbPath) end)
...
function UIMessageTips:init()
	self._textMessageTips  = Util:seekNodeByName(self, "txtTip",  "ccui.Text")
	self._panelTips = Util:seekNodeByName(self, "panelLayout", "ccui.Layout")
end
