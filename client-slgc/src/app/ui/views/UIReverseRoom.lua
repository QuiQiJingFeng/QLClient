local csbPath = "ui/csb/mengya/UIReverseRoom.csb"
local super = game.UIBase
local Util = game.Util
local UIManager = game.UIManager
local UITableView = game.UITableView
local UIReverseRoomLeftItem = require("app.ui.items.UIReverseRoomLeftItem")
local ConfigManager = game.ConfigManager
local UIReverseSetting = require("app.ui.views.UIReverseSetting")

local UIReverseRoom = class("UIReverseRoom", super, function() return game.Util:loadCSBNode(csbPath) end)
