local csbPath = "ui/csb/mengya/club/email/UIClubMessage.csb"
local super = game.UIBase
local Util = game.Util
local UIManager = game.UIManager
local UITableView = game.UITableView
local UIClubMessageLeftItem = import("items.UIClubMessageLeftItem")
local UIClubMessageOperation = import("views.UIClubMessageOperation")
local UIClubMessageApproving = import("views.UIClubMessageApproving")
local UIClubMessageNotice = import("views.UIClubMessageNotice")
local UIClubMessageEmail = import("views.UIClubMessageEmail")

local UIClubMessage = class("UIClubMessage", super, function() return game.Util:loadCSBNode(csbPath) end)
...
function UIClubMessage:_onBtnBackClick()
    UIManager:getInstance():hide("views.UIClubMessage")
end
