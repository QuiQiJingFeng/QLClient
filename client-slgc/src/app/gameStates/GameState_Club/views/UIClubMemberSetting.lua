local csbPath = "ui/csb/mengya/club/UIClubMemberSetting.csb"
local super = game.UIBase
local Util = game.Util
local UIManager = game.UIManager
local UITableView = game.UITableView
local UIClubMemberSettingItem = import("items.UIClubMemberSettingItem")

local UIClubMemberSetting = class("UIClubMemberSetting", super, function() return game.Util:loadCSBNode(csbPath) end)
...
function UIClubMemberSetting:hideAction()
    ...
    local act2 = cc.CallFunc:create(function()
		UIManager:getInstance():hide("views.UIClubMemberSetting")
    end)
