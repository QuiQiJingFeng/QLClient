local csbPath = "ui/csb/mengya/club/UIClubMember.csb"
local super = game.UIBase
local Util = game.Util
local UIManager = game.UIManager
local UITableView = game.UITableView
local UIClubMemberItem = import("items.UIClubMemberItem")
local UIClubMember = class("UIClubMember", super, function() return Util:loadCSBNode(csbPath) end)
...
function UIClubMember:_onItemClick(item,data,eventType)
    if ccui.TouchEventType.ended == eventType then
        UIManager:getInstance():show("views.UIClubMemberInfo",data)
    end
end
...
function UIClubMember:_onBtnInviteMemberClick()
    UIManager:getInstance():show("views.UIClubMemberInvite")
end

function UIClubMember:_onBtnBackClick()
    UIManager:getInstance():hide("views.UIClubMember")
end
