local csbPath = "ui/csb/mengya/club/UIClubMemberInfo.csb"
local super = game.UIBase
local Util = game.Util
local UIManager = game.UIManager
local UIClubMemberInfo = class("UIClubMemberInfo", super, function() return game.Util:loadCSBNode(csbPath) end)
