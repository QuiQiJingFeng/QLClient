local csbPath = "ui/csb/mengya/club/UIClubDataStatistics.csb"
local super = game.UIBase
local Util = game.Util
local UIManager = game.UIManager
local UITableView = game.UITableView
local UIClubDataStatisticsItem = import("items.UIClubDataStatisticsItem")
local UIClubDataStatistics = class("UIClubDataStatistics", super, function() return game.Util:loadCSBNode(csbPath) end)
...
function UIClubDataStatistics:_onBtnBackClick()
    UIManager:getInstance():hide("views.UIClubDataStatistics")
end
